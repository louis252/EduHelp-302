...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center @if(auth()->user()->phone === null) disabled @endif" href="/volunteer_dashboard">
            ...
            <li class="nav-item {{ ($title === "Dashboard" ? 'active' : '') }}">
                <a class="nav-link @if(auth()->user()->phone === null) disabled @endif" href="/volunteer_dashboard">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="/volunteer_profile">
