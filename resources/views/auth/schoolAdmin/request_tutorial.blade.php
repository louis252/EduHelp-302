...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add a New Tutorial Request</h1>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <!-- Card Body -->
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('tutorial_request') }}" method="POST">
                        @csrf
                        <div class="col-12 pt-1" style="margin-left: 0px; padding-left:0px">
                            <!-- Tutorial Request -->
                            <div class="col-12" style="margin-left: 0px; padding-left:0px" id="tutorReq">
                                <div class="d-flex col-12 pt-3" style="margin-left: 0px; padding-left:0px">
                                    <div class="col-4" id="sandbox-container">
                                        ...
                                        <input type="text" class="form-control @error('proposedDate') is-invalid @enderror" id="proposedDate" name="proposedDate" required placeholder="yyyy-mm-dd" readonly style="background-color: #fff">
                                        @error('proposedDate')
                                    ...
                                    <div class="col-4" id="sandbox-container-2">
                                        <label for="proposedTime"> Proposed Time: </label>
                                        <input type="text" class="form-control @error('proposedTime') is-invalid @enderror" id="proposedTime" name="proposedTime" autocomplete="off" data-container="#sandbox-container-2" data-toggle="timepicker" required readonly style="background-color: #fff">
                                        @error('proposedTime')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="d-flex col-12 pt-3" style="margin-left: 0px; padding-left:0px">
                                    <div class="col-4 pt-3">
                                        <label for="studentLevel"> Student Level (1-5): </label>
                                        <input id="studentLevel" class="form-control @error('studentLevel') is-invalid @enderror" name="studentLevel" autocomplete="off" required>
                                        @error('studentLevel')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-4 pt-3">
                                        <label for="numStudent"> Num of Student: </label>
                                        <input id="numStudent" class="form-control @error('numStudent') is-invalid @enderror" name="numStudent" autocomplete="off" required>
                                        @error('numStudents')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
